...
private extension FeedCVC {
	...
	func createCellRegistration () -> UICollectionView.CellRegistration<PhotoCell, FeedPhotoModel> {
		.init(cellNib: PhotoCell.xib()) { cell, indexPath, item in
			cell.photo = item
		}
	}

	func createDataSource (cellRegistration: UICollectionView.CellRegistration<PhotoCell, FeedPhotoModel>) -> FeedDataSource {
